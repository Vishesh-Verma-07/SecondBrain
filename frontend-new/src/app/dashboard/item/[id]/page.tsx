...
export default function ItemPage() {
  ...
  async function copyLink() {
    try {
      ...
      setMessage("Copy the URL from your browser to share this item.");
    }
  }
  ...
  const categoryName =
    ...
    categories.find((category) => category._id === itemCategoryId)?.name;
  return (
    <main className="detail-page">
      <Link className="back-link" href="/dashboard">
        ← Back to dashboard
      ...
      <section className="detail-meta" aria-label="Item metadata">
        <div>
          <small>CREATED</small>
          <p>
            {item.createdAt
